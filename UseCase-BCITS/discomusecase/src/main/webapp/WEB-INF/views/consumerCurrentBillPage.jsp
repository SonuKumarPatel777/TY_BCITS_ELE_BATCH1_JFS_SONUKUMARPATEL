...
<body>
    <table style="font-size: 20px;background-color: white; margin-left: 250px;">
                ...
                <% if((currentBillBean.getStatus()).equalsIgnoreCase("Not paid")){ %>
                    <td></td>
                    <td> <a href="./consumerPaymentPage">
                    <input type="button" value="Online Payment" style="background-color:green;margin-top: 10px"></a>
                    <td></td>
                  <%}else{ %> 
                      <h3 style="color:green; margin-left: 280px">Bill already paid</h4>
                  <%} %> </td>
                </tr>
            </table>
