...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-dark">
            ...
            <h2 style="color:white;margin-left:50px">Bangalore Electicity Supply Company Limited</h2><br>
            <a href="/discomusecase/admin/adminLoginPage" style="margin-left:50px">
